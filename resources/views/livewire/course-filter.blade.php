        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-4">
            <aside class="col-span-1 ">
                ...
                <div class="mb-4">
                    ...
                    <x-select
                        class="bg-gray-800 text-white rounded-md px-4 py-2 w-full focus:ring-2 focus:ring-blue-500">
            ...
            <div class="col-span-1 lg:col-span-3">
                <div class="mb-12">
                    <x-input wire:model.live="search" placeholder="Buscar curso"
                        class=" bg-gray-800 text-white px-4 py-2 rounded-full w-full  focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                {{-- Listado de cursos --}}
                ...
                <ul class="space-y-4">
                    ...
                    <li wire:key="course-{{ $course->id }}">
                        <div
                            class="bg-gray-800 hover:bg-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                                ...
                                <div class="flex-1 mt-2 sm:mt-0 sm:ml-4 ">
                                    ...
                                    <p class="font-semibold mb-2">
                                        ...
                                        <span class="text-gray-400">
                                            ...
                                            number_format($course->price_mxn) }} MXN)
                                        </span>
